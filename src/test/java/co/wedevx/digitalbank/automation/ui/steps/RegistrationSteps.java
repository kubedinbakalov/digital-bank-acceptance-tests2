...
public class RegistrationSteps {
    ...
    List<Map<String,Objects>> nextValList =new ArrayList<>();
    ...
    public void theFollowingUserInfoShouldBeSavedInTheDb(List<Map<String,String>> expectedUserProfileInfoInDBList) {
        ...
        List<Map<String, Objects>> actualUserInfoList = DBUtils.runSQLSelectQuery(queryUserTable);
        List<Map<String, Objects>> actualUserProfileInfoList = DBUtils.runSQLSelectQuery(queryUserProfile);
        ...
        Map<String,Objects> actualUserInfoMap = actualUserInfoList.get(0);
        Map<String,Objects> actualUserProfileInfoMap = actualUserProfileInfoList.get(0);

        assertEquals(expectedUserInfoMap.get("title"),actualUserProfileInfoMap.get("title"),"Registration generated wrong title");
        assertEquals(expectedUserInfoMap.get("firstName"), actualUserProfileInfoMap.get("firstName"), "Registration generated wrong firstName");
        assertEquals(expectedUserInfoMap.get("lastName"),actualUserProfileInfoMap.get("lastName"),"Registration generated wrong LastName");
        ...
        assertEquals(expectedUserInfoMap.get("postalCode"),actualUserProfileInfoMap.get("postalCode"),"Registration generated wrong postalCode");
        ...
        assertEquals(expectedUserInfoMap.get("accountNonExpired"),String.valueOf(actualUserProfileInfoMap.get("account_non_expired")),"accountNonExpired mismatch upon registration");
        assertEquals(expectedUserInfoMap.get("accountNonLocked"),String.valueOf(actualUserProfileInfoMap.get("account_non_locked")),"accountNonLocked mismatch upon registration");
        assertEquals(expectedUserInfoMap.get("credentialsNonExpired"),String.valueOf(actualUserProfileInfoMap.get("credentials_non_expired")),"credentialsNonExpired mismatch upon registration");
        assertEquals(expectedUserInfoMap.get("enable"),String.valueOf(actualUserProfileInfoMap.get("enable")),"account enable mismatch upon registration");
        assertEquals(expectedUserInfoMap.get("email"),actualUserProfileInfoMap.get("username"),"username mismatch upon registration");

        assertEquals(nextValList.get(0).get("next_val"),actualUserProfileInfoMap.get("id"),"Id mismatch");
